...
export default async function handler(req, resp) {
	...
	if(!stats){
		await BlackjackStats.create({
			...
			totalDiceThrownByAI: body.totalDiceThrownByAI,
			sumDiceThrownByUser: body.sumDiceThrownByUser,
			sumDiceThrownByAI: body.sumDiceThrownByAI,
			total21ByUser: body.total21ByUser,
			total21ByAI: body.total21ByAI,
			totalBustByUser: body.totalBustByUser,
			totalBustByAI: body.totalBustByAI
		})
	}else{
